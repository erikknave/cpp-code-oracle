...
func (f FunctionCall) Execute(args json.RawMessage) (string, error) {
	...
	return f.Function(params.Question, params.Dbid), nil
...
func (f FunctionCall) Function(question string, dbid string) string {
